...
public class MathUtilsTest {
    ...
    private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(MathUtilsTest.class);
    @BeforeAll
    ...
    public void testMax6(){
        assertEquals(Integer.MAX_VALUE-1, mathUtils.max(Integer.MAX_VALUE-1, Integer.MAX_VALUE-2));
    }
